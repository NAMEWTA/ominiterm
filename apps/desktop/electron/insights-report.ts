...
<title>OminiTerm Insights Report</title>
<style>
  :root {
    --bg: #101412;
...
<body>
  <div class="wrap">
    <header class="masthead">
      <div class="eyebrow">OminiTerm Intelligence Report</div>
    ...
    <div class="footer">Generated by OminiTerm · unified cross-CLI scanning, tiered facet extraction, and self-contained HTML reporting.</div>
  </div>
  <script>
