...
const SYNC_QUEUE_FILE = path.join(OMINITERM_DIR, "sync-queue.jsonl");
const BACKFILL_FLAG = path.join(OMINITERM_DIR, "sync-backfilled");
 ...
 * Uses ~/.ominiterm/sync-backfilled flag to avoid re-running.
 */
