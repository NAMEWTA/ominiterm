export const en = {
  ...
  shortcut_show_shortcut_hints: "Hold shortcut guide",
  shortcut_context_escape: "Exit / cancel",
  shortcut_context_composer_send: "Composer send",
  shortcut_context_composer_newline: "Composer newline",
  shortcut_context_slash_next: "Slash menu next",
  ...
  shortcuts_app_section: "Application shortcuts",
  shortcuts_context_section: "Context shortcuts",
  ...
  launcher_step_command_placeholder: "pnpm install",
  launcher_step_timeout_ms: "Timeout (ms)",
  launcher_move_up: "Move up",
  ...
  // Welcome popup
  welcome_title: "ominiterm",
  welcome_heading: "Welcome to OminiTerm!",
