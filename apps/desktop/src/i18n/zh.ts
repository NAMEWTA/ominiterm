export const zh = {
  ...
  shortcut_show_shortcut_hints: "按住查看快捷键",
  shortcut_context_escape: "退出 / 取消",
  shortcut_context_composer_send: "Composer 发送",
  shortcut_context_composer_newline: "Composer 换行",
  shortcut_context_slash_next: "Slash 菜单下一项",
  ...
  shortcuts_app_section: "应用级快捷键",
  shortcuts_context_section: "上下文快捷键",
  ...
  launcher_step_timeout_ms: "超时（毫秒）",
  launcher_move_up: "上移",
  ...
  welcome_heading: "欢迎使用 OminiTerm！",
